var _rollbarConfig = {
	accessToken: "914f460574944388bfdeefe96bad3028",
	captureUncaught: true,
	captureUnhandledRejections: true,
	transform: function (payload) {
		payload.request.url = "index";
	},
	payload: {
		environment: process.env.NODE_ENV || "prod",
		context: window.rapierConfig.version
	}
};
!function (r) {
	function o(n) {
	...
	function l(r) {
		return n(function () {
			var o = this, e = Array.prototype.slice.call(arguments, 0), n = {shim: o, method: r, args: e, ts: new Date};
